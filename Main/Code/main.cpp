...
struct DumperOptions {
    bool enableTotalDump = true;
    bool enableImportantDump = true;
    bool enableVectorTracking = false;
    bool enableStringRelation = true;
    bool enableRealTimeOutput = true;
    bool enableComprehensiveDump = true;
    bool enableAddressDiscovery = true;
    bool enableConnectionAnalysis = true;
    bool enableConsoleMonitoring = true;
    bool enableDetailedLogging = true;
    bool enableFileGrouping = true;
    bool enablePositionVectorTracking = false;
    bool enableDamageVectorTracking = false;
    bool enableVectorChangeLogging = false;
    bool enableAllStringDump = false;
    bool enableRelatedStringsOnly = true;
    bool enableImportantStringsOnly = true;
};
...
static std::unordered_map<std::string, std::vector<std::string>> g_stringToClassMap;
